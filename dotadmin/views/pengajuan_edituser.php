...
//audit trails
 date_default_timezone_set('Asia/Jakarta');
        ...
        $content        = 'User Mengedit Pengajuan'; 
    ...
    <div class="panel-body">
        <form role="form" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="status_pengajuan" readonly="readonly" value="Menunggu"<?php echo $data['status_pengajuan']; ?>">
                    </div>
                    <!-- <div class="form-group">
                        <label>Status Pengajuan</label>
