    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html"><h6><b>DISTINCTION ON TECHNOLOGY</b></h6></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="#">Human Resources Departement <span></span></a>
                    </li>
                    <li>
                        <a href="karyawan_index.php">Data Karyawan <span></span></a>
                    </li>
                     <li>
                        <a href="absensi.php">Absensi <span></span></a>
                    </li>
                    <li>
                        <a href="perizinan.php">Perizinan <span></span></a>
                    </li>
                    <li>
                        <a href="#">Gaji Pegawai <span></span></a>
                    </li>
                    <li>
                        <a href="#">Pengajuan Barang <span></span></a>
                    </li>
                    <li>
                        <a href="#">Peminjaman Barang <span></span></a>
                    </li>
                    <li>
                        <a href="#">Pengembalian Barang <span></span></a>
                    </li>
                    <li>
                        <a href="#">Barang Keluar <span></span></a>
                    </li>
                    <li>
                        <a href="#">Rancangan Anggaran Biaya <span></span></a>
                    </li>
                    <li>
                        <a href="#">Manajemen Proyek <span></span></a>
                    </li>
                    <li>
                        <a href="#">Dokumentasi Proyek <span></span></a>
                    </li>
                </ul>
